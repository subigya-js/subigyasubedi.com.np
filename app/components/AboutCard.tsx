...
const AboutCard = () => {
    return (
        <div className='flex flex-col px-6 py-10 gap-6 bg-[#1b1c1c] rounded-3xl'>
            ...
            <Link href="/about" className="flex items-center gap-2 bg-gray-200 hover:bg-gray-200/80 hover:scale-105 duration-200 w-fit text-black px-4 py-2 rounded-full text-md">LEARN MORE <MdOutlineArrowRightAlt size={20} />
            </Link>
        </div>
    )
}
