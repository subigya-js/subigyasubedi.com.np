  ...
  return (
    <footer className={`bg-[#1b1c1c] rounded-3xl px-6 py-4 mb-5 min-w-[50%] ${font.className}`} suppressHydrationWarning>
      <div className="flex justify-between items-center text-gray-300">
        <p className="text-[8px] sm:text-xs font-medium">
        ...
        <p className="text-[8px] sm:text-xs">Design Inspired by: <Link href="https://github.com/kreatordev" target="_blank" className="hover:text-white hover:underline duration-300">KreatorDev</Link></p>
      </div>
    </footer>
  );
};
